...
dataset_name = '2021_Clarkefield_Thistle_v0_2021-12-10'
...
Thistle = WeedModel(weed_name='thistle', model_name=dataset_name)
dataset_path = Thistle.create_train_test_val_datasets(img_dirs,
                                                        ann_files,
                                                        hp,
                                                        dataset_name,
                                                        annotation_type=model_type,
...
# load dataset
dso = Thistle.load_dataset_objects(dataset_path)

# ======================================================================================
# train model
# ======================================================================================
print('Training model')
model, model_save_path, best_epoch = Thistle.train(model_name=dataset_name,
...
model_names = [Thistle.get_model_name()]
...
res = Thistle.compare_models(models,
                         datasets,
                         load_prcurve=False,
                         show_fig=True)
