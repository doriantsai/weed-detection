...
#                      recursive=True)
glob_img = glob.glob(str(root_dir + '/2021-03-26/Location_2/images/' + pattern_img),
                     recursive=True)
# glob_img.extend(glob_img2)

# glob for all annotation files
pattern_ann = '*labels_polygons.json'
glob_ann = glob.glob(str(root_dir + '/2021-03-26/Location_2/metadata/' + pattern_ann ),
                     recursive=True)
...
out_dir = os.path.join('/home/dorian/Data/AOS_TussockDataset/2021-03-26_MFS_Horehound')
...
ann_out = '2021-03-26_MFS_Horehound.json'
