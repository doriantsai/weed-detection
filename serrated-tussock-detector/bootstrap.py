...
from inference import show_groundtruth_and_prediction_bbox, get_prediction
...
if __name__ == "__main__":
    ...
    print('load model: {}'.format(save_path))
    ...
    for f in files:
        ...
        pred, keep = get_prediction(model, img_rs, conf_thresh, iou_thresh, device, class_names)
